...
public class FastNoise
{
    ...
    public IntPtr GetKeyNoise()
    {
        return mNodeHandle;
    }
    
    public float GenSingle2D(float x, float y, float size, int seed)
    {
        return fnGenSingle2D(mNodeHandle, x*size, y*size, seed);
    }

    public float GenSingle3D(float x, float y, float z, float size, int seed)
    {
        return fnGenSingle3D(mNodeHandle, x*size, y*size, z*size, seed);
    }

    public float GenSingle4D(float x, float y, float z, float w, float size, int seed)
    {
        return fnGenSingle4D(mNodeHandle, x*size, y*size, z*size, w*size, seed);
    }
    ...
    static public Dictionary<string, int> metadataNameLookup;
    static public Metadata[] nodeMetadata;
    ...
    [DllImport(NATIVE_LIB)]
    public static extern float fnGenSingle2D(IntPtr node, float x, float y, int seed);
